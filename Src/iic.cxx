...
I2C::I2C(const I2C_Dev_* dev_) noexcept
: dev(dev_)
{
    i2c1 = this;
    delay_us(100);
    ...
    dma.DMA_PeripheralBaseAddr = reinterpret_cast<uint32_t>(&(dev->I2C->DR));
...
int8_t I2C::write_data_async(uint8_t addr, uint8_t _reg, uint8_t* _data, void (*cb)(uint8_t), bool is_blocking)
{
    if (check_busy())
        return RESULT_BUSY;
...
extern "C"
{
    ...
    void DMA1_Stream0_IRQHandler(void)
    {
        if (DMA_GetFlagStatus(DMA1_Stream0, DMA_FLAG_TCIF0))
        {
            ...
            i2c1->transfer_complete_cb(); // TODO make this configurable
        }
    }
    void I2C1_ER_IRQHandler(void) { i2c1->handle_error(); }

    void I2C1_EV_IRQHandler(void) { i2c1->handle_event(); }
}
