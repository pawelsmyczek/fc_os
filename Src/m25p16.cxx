...
M25P16::M25P16(SPI* _spi) noexcept
: spi(_spi)
{
    spi->set_spi_divisor(16);
}
M25P16::~M25P16() noexcept
{}

void M25P16::init_m25p16(void)
{

}
uint8_t M25P16::get_status(void)
{
    spi->spi_enable();
...
void M25P16::read_config(uint8_t *data, uint32_t len, uint8_t addr_start)
{
    // READ DATA COMMAND
...
void M25P16::read_mem(uint8_t* data, uint8_t len)
{
    (void)data;
    (void)len;
}
