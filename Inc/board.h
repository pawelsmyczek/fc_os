...
const SPI_Dev_ M25P16_ =
        {
                ...
                .IRQChannel =           0,
                .DMA_Channel =          0,
                .TX_DMA_Stream =        nullptr,
                .RX_DMA_Stream =        nullptr,
...
//        .RX_Pin         = GPIO_Pin_1,
//        .Tx_Pin         = GPIO_Pin_0,
//        .RX_PinSource   = GPIO_PinSource1,
//        .TX_PinSource   = GPIO_PinSource0,
        .USART_IRQn     = UART4_IRQn,
        .Rx_DMA_IRQn    = DMA1_Stream2_IRQn,
        .Tx_DMA_IRQn    = DMA1_Stream4_IRQn,
        .Rx_DMA_Stream  = DMA1_Stream2,
        .Tx_DMA_Stream  = DMA1_Stream4,
        .DMA_Channel    = DMA_Channel_4,
        .DMA_Rx_IT_Bit  = DMA_IT_TCIF2,
        .DMA_Tx_IT_Bit  = DMA_IT_TCIF4,
        };
